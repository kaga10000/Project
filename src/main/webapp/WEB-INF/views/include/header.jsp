	...
	<header>
		...
		<div class="dropmenu" style="width: 85%; height: 100px; margin-top: 20px;">
			...
			<c:choose>
					...
					<div id="Member_border" style="width: 100%; text-align: center;">
			<div id="Memberinfo">
					...
					<c:otherwise>
<div id="logininfo" style="width: 100%; text-align: center;">
						<ul style="height: 30px; text-align: center; width: 100%;">
							<li style="height: 30px; text-align: center; width: 100%;">${sessionScope.id}님&nbsp&nbsp환영합니다!</li>
						</ul>
</div>
						<div id="loginbtn_area" style="text-align: center; width: 100%;"> 
